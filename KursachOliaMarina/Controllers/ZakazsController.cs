...
namespace KursachOliaMarina.Controllers
{
    public class ZakazsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ZakazName,DateOfZakaz,UserId")] Zakaz zakaz)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ZakazName,DateOfZakaz,UserId")] Zakaz zakaz)
        {
            if (ModelState.IsValid)
            {
